...
<div class="max-w-4xl mx-auto">
    ...
    <div class="lvl-panel p-8">
        ...
        <div class="space-y-6">
            ...
            <!-- Level Requirement -->
            <div class="rounded-xl border p-4" style="border-color:var(--lvl-border-soft);background:var(--lvl-surface-raised);">
            ...
            <div class="space-y-3">
                ...
                <div class="rounded-xl border p-4" style="border-color:var(--lvl-border-soft);background:var(--lvl-surface-raised);">
                    ...
                    <!-- Progress Bar -->
                    <div class="w-full bg-[var(--lvl-surface-soft)] rounded-full h-2 border border-[var(--lvl-border-soft)]">
        ...
        <div class="mt-8">
            @if($isUnlocked)
            <div class="rounded-xl p-6 text-center border-2 border-green-500/30" style="background: rgba(34, 197, 94, 0.08);">
            ...
            <form action="{{ route('skill-tree.unlock', $node) }}" method="POST">
                @csrf
                <button type="submit" class="w-full btn-glow px-8 py-3 rounded-lg font-bold text-lg">
            ...
            @else
            <div class="rounded-xl p-6 text-center border-2 border-red-500/30" style="background: rgba(239, 107, 107, 0.08);">
