...
<div class="max-w-3xl mx-auto">
    ...
    <div class="relative glow-border rounded-3xl bg-gradient-to-br from-purple-900/40 via-pink-900/30 to-purple-900/40 backdrop-blur">
        ...
        <div class="relative p-8">
            <form action="{{ route('resume.update', $resume) }}" method="POST" class="space-y-7">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <textarea name="job_description" rows="6"
                        ...
                        class="w-full bg-purple-950/40 border border-purple-500/30 rounded-xl px-4 py-3 text-white placeholder-purple-400/40 focus:outline-none focus:border-purple-400 focus:ring-1 focus:ring-purple-400 transition resize-none">{{ old('job_description', $resume->job_description) }}</textarea>
                </div>
                ...
                {{-- Regenerate AI notice --}}
                <div class="flex items-start gap-3 bg-yellow-900/20 border border-yellow-500/20 text-yellow-300/70 px-4 py-3 rounded-2xl text-sm">
                    <svg class="w-4 h-4 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                    Saving will update your resume info and recalculate your keyword match score. To regenerate the AI content and PDF, use the <strong class="text-yellow-300/90 mx-1">Regenerate PDF</strong> button after saving.
                </div>
